...
pub contract SwapToken {
    ...
    pub fun swapTokens(signer: AuthAccount, swapAmount: UFix64) {
        ...
        let pranavtokenVault = signer.borrow<&pranavtoken.Vault>(from: /storage/VaultStorage)
        ...
        let minterRef = signer.getCapability<&pranavtoken.Minter>(/public/Minter).borrow()
        ...
        pranavtokenVault.deposit(from: <-newVstokenVault)
